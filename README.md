...
This repository contains the code for the experimentation on quantum optimization using QAOA. We investigate the impact of input scaling on the cost landscape and optimization performance of QAOA.
